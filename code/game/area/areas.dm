...
/area/Entered(atom/movable/M)
	...
	if(L.client && !L.client.ambience_playing && L.client.prefs.toggles & SOUND_SHIP_AMBIENCE)
		...
		SEND_SOUND(L, sound('modular_ss220/modules/music&sounds/sound/ambience/shipambience.ogg', repeat = 1, wait = 0, volume = 25, channel = CHANNEL_BUZZ)) //SS220 EDIT - original: 'sound/ambience/shipambience.ogg' 'volume = 35'

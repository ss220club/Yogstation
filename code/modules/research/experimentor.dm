...
/obj/machinery/rnd/experimentor/ui_interact(mob/user)
	...
	if(loaded_item)
		...
		dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_POKE]'>Poke</a><a href='byond://?src=[REF(src)];function=[SCANTYPE_POKE];toggle_auto=1' class='[autoexperiment==SCANTYPE_POKE?"linkOn":""]'>A</a></b>"
		dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_IRRADIATE]'>Irradiate</a><a href='byond://?src=[REF(src)];function=[SCANTYPE_IRRADIATE];toggle_auto=1' class='[autoexperiment==SCANTYPE_IRRADIATE?"linkOn":""]'>A</a></b>"
		dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_GAS]'>Gas</a><a href='byond://?src=[REF(src)];function=[SCANTYPE_GAS];toggle_auto=1' class='[autoexperiment==SCANTYPE_GAS?"linkOn":""]'>A</a></b>"
		dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_HEAT]'>Burn</a><a href='byond://?src=[REF(src)];function=[SCANTYPE_HEAT];toggle_auto=1' class='[autoexperiment==SCANTYPE_HEAT?"linkOn":""]'>A</a></b>"
		dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_COLD]'>Freeze</a><a href='byond://?src=[REF(src)];function=[SCANTYPE_COLD];toggle_auto=1' class='[autoexperiment==SCANTYPE_COLD?"linkOn":""]'>A</a></b>"
		dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_OBLITERATE]'>Destroy</a><a href='byond://?src=[REF(src)];function=[SCANTYPE_OBLITERATE];toggle_auto=1' class='[autoexperiment==SCANTYPE_OBLITERATE?"linkOn":""]'>A</a></b></div>"
		if(istype(loaded_item,/obj/item/relic))
			dat += "<b><a href='byond://?src=[REF(src)];function=[SCANTYPE_DISCOVER]'>Discover</A></b>"
